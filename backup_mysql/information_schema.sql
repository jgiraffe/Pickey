...
--
-- 뷰 구조 `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- 뷰 구조 `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- 뷰 구조 `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- 뷰 구조 `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- 뷰 구조 `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- 뷰 구조 `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- 뷰 구조 `XTRADB_INTERNAL_HASH_TABLES`
--
